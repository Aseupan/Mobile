...
class SectionOnboarding1 extends StatefulWidget {
  const SectionOnboarding1({super.key});

  @override
  State<SectionOnboarding1> createState() => SectionOnboarding1State();
}

class SectionOnboarding1State extends State<SectionOnboarding1> {
  @override
